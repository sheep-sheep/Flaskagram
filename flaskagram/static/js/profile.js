$(function () {
    var oExports = {
        ...
        renderMore: fRenderMore, // Redner more data
        requestData: fRequestData, // Request data
        tpl: fTpl,  // Replace the template
    };

    oExports.initialize();  // initialize the function

    function fInitialize() {
        var that = this;

        that.listEl = $('div.js-image-list'); // find the image list element
        // init
        that.uid = window.uid;
        that.page = 1;
        that.pageSize = 3;
